    ...
    <div class="mt-8">
        ...
        <div class="mt-6">
            <div class="flex justify-between">
                ...
                <div>
                    <button type="submit" wire:click="$emitTo('categorias-child', 'showCreateForm');"
                    ...
                    <tr class="hover:bg-violet-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-4">
                                {{-- Editar --}}
                                <button type="submit"
                                    wire:click="$emitTo('categorias-child', 'showEditForm', {{ $result->ID_CAT}});"
                                ...
                                {{-- Eliminar --}}
                                <button type="submit"
                                    wire:click="$emitTo('categorias-child', 'showDeleteForm', {{ $result->ID_CAT}});"
                                    class="material-icons-round text-base">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
