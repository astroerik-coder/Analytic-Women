<div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-tall-crud-label>Nombre Gen</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.NOMBRE_GEN" />
                @error('item.NOMBRE_GEN') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
        </x-slot>
