    ...
    <div class="mt-8">
        ...
        <div class="mt-6">
            <div class="flex justify-between">
                ...
                <div>
                    <button type="submit" wire:click="$emitTo('provincias-child', 'showCreateForm');"
                        ...
                        <span class="relative text-black group-hover:text-white">Agregar Provincia</span>
                    </button>
                </div>
            </div>
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 mt-8"
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100 ">
                    ...
                    <tr class="hover:bg-violet-50 {{ ($loop->even ) ? " hover:bg-violet-100" : "" }}">
                        ...
                        <td class="px-6 py-4">{{ $result->NOMBRE_PRO }}</td>
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-4">
                                {{-- Editar --}}
                                <button type="submit"
                                    wire:click="$emitTo('provincias-child', 'showEditForm', {{ $result->ID_PRO}});"
                                ...
                                {{-- Eliminar --}}
                                <button type="submit"
                                    wire:click="$emitTo('provincias-child', 'showDeleteForm', {{ $result->ID_PRO}});"
                                    class="material-icons-round text-base">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
