<div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-tall-crud-label>Nombre Pag</x-tall-crud-label>
            ...
            <div class="mt-4">
                <x-tall-crud-label>Metodo Pag</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.METODO_PAG" />
                @error('item.METODO_PAG') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
            <div class="mt-4">
                <x-tall-crud-label>Fecha Pag</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.FECHA_PAG" />
                @error('item.FECHA_PAG') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
            <div class="mt-4">
                <x-tall-crud-label>Monto Pag</x-tall-crud-label>
