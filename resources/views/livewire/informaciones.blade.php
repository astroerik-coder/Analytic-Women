<section class="antialiased bg-gray-100 text-black  px-4 mb-5">
    <div class="mt-8">
        <div class="text-2xl">Información</div>
    </div>
    ...
    <div class="mt-6">
        <div class="flex justify-between">
            ...
            <div>
                <button type="submit" wire:click="$emitTo('informaciones-child', 'showCreateForm');"
                    ...
                    <span class="relative text-black group-hover:text-white">Agregar Información</span>
                </button>
            </div>
                ...
                <tr class="hover:bg-blue-300 {{ ($loop->even ) ? " bg-blue-100" : "" }}">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-center gap-4">
                            {{-- Editar --}}
                            <button type="submit"
                                wire:click="$emitTo('informaciones-child', 'showEditForm', {{ $result->ID_INF}});"
                            ...
                            {{-- Eliminar --}}
                            <button type="submit"
                                wire:click="$emitTo('informaciones-child', 'showDeleteForm', {{ $result->ID_INF}});"
                                class="material-icons-round text-base">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
