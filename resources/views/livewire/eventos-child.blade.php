<div>
    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <x-slot name="content">
            <div class="mt-4">
                <x-tall-crud-label>Nombre Evt</x-tall-crud-label>
            ...
            <div class="mt-4">
                <x-tall-crud-label>Descripcion Evt</x-tall-crud-label>
            ...
            <div class="mt-4">
                <x-tall-crud-label>Fecha Evt</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.FECHA_EVT" />
                @error('item.FECHA_EVT') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
            <div class="mt-4">
                <x-tall-crud-label>Hora Evt</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.HORA_EVT" />
                @error('item.HORA_EVT') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
            <div class="mt-4">
                <x-tall-crud-label>Observaciones Evt</x-tall-crud-label>
            ...
            <div class="mt-4">
                <x-tall-crud-label>Ubicacion Evt</x-tall-crud-label>
