...
<body class="bg-gray-100">
  ...
  <div class="slider relative w-full h-screen overflow-hidden">
    <div class="slide absolute top-0 left-0 w-full h-full bg-cover bg-center opacity-0 transition-opacity duration-500"
      ...
      <div class="overlay absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
      <div class="flex flex-col items-center">
        <h2 class="text-3xl font-bold" style="position: absolute; top: 50%; transform: translate(-50%, -50%); left: 50%;">¿Quiénes somos?</h2>
      ...
      <div class="overlay absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
        <div class="flex flex-col items-center">
          <h2 class="text-3xl font-bold"
            style="position: absolute; top: 50%; transform: translate(-50%, -50%); left: 50%;">Servicios de asesoría y consultoría empresarial e institucional</h2>
          <p class="text-center" style="position: absolute; top: 60%; transform: translate(-50%, -50%); left: 50%;">
            De acuerdo a los requerimientos de nuestros clientes, como la elaboración de estudios de factibilidad financiera de los proyectos.
          </p>
        </div>
      </div>
    </div>
      <div
        class="slide absolute top-0 left-0 w-full h-full bg-cover bg-center opacity-0 transition-opacity duration-500"
        ...
        <div class="overlay absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
          <div class="flex flex-col items-center">
            <h2 class="text-3xl font-bold" style="position: absolute; top: 50%; transform: translate(-50%, -50%); left: 50%;">Ejes de trabajo</h2>
            <p class="text-center" style="position: absolute; top: 60%; transform: translate(-50%, -50%); left: 50%;">
    ...
    <div
      class="w-full p-10 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-20 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div
          ...
          <div class="mb-8">
            ...
            <p class="text-grey-darker text-base">
              ...
              Experiencia en Desarrollo de software para la banca privada: PRODUBANCO y Banco Pichincha. Análisis de
              bases
              de datos de Instituciones Públicas. Desarrollo
              de proyectos sociales con organizaciones de mujeres y grupos vulnerables, Coordinación con la academia
              para
        ...
        <div
          ...
          <div class="mb-8">
            ...
            <p class="text-grey-darker text-base">
              ...
              de servicios. Elaboración de lineamentos comerciales con aplicación nacional. Diseño y manejo de
              indicadores
