		...
		<div class="container mx-auto">
			<div class="flex justify-center px-6 my-12">
				...
				<div class="w-full xl:w-3/4 lg:w-11/12 flex">
					<!-- Col -->
					<div class="w-full h-auto bg-white hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
						style="background-image: url('https://source.unsplash.com/Mv9hjnEUHR4/600x800')"></div>
					<!-- Col -->
					<div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
						<h3 class="pt-4 text-2xl text-center">Contáctanos!</h3>
						<hr><br>
							...
							<div class="mb-4 md:flex md:justify-between">
								<div class="mb-4 md:mr-2 md:mb-0">
									...
									<input
										...
										id="nombre" name="nombre" type="text" placeholder="Primer Nombre" />
								</div>
								<div class="md:ml-2">
									...
									<input
										class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
										id="apellidos" name="apellidos" type="text" placeholder="Apellido" />
								</div>
							</div>
							<div class="mb-4">
